...
int main(int argc, char **argv)
{
    ...
    goal1.target_pose.pose.position.x = 1.829461; //x，相对于建图起点前后的值，前正后负
    goal1.target_pose.pose.position.y = -1.098057; //y，相对于建图起点左右的值，左正右负
    ...
    goal2.target_pose.pose.position.x = 0.409110;
    goal2.target_pose.pose.position.y = -1.703288;
